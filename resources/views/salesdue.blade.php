                                ...
                                <div class="row m-25">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <p class="f-500 m-b-15 c-black duetype">Report Type</p>
                                                <select class="selectpicker" title='Report Type' id="duetype" name="duetype">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <p class="f-500 m-b-15 c-black doctype">Weeks</p>
                                                <select class="selectpicker" title='Choose Weeks' id="weeks" name="weeks">
                                                    <option value="invoice">Invoice Only</option>
                                                    <option value="invpo">Invoice & Order</option>
                                                </select>
                                            </div>
