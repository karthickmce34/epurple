        ...
        <section id="main">
           <aside id="sidebar" class="sidebar " style="overflow: visible;">
                ...
                <ul class="main-menu">
                    ...
                    <li class="active"> <a href="paymentdue"><i class="zmdi zmdi-view-list"></i> Purchase Payment</a></li>
                                ...
                                <div class="row m-25">
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <p class="f-500 m-b-15 c-black">Report Type</p>
                                                <select class="selectpicker" title='Report Type' id="reporttype" name="reporttype">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <p class="f-500 m-b-15 c-black duetype">Due Type</p>
                                                <select class="selectpicker" title='Due Type' id="duetype" name="duetype">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <p class="f-500 m-b-15 c-black doctype">Document Type</p>
                                                <select class="selectpicker" title='Document Type' id="doctype" name="doctype">
                                                    <option value="invoice">Invoice Only</option>
                                                    <option value="invpo">Invoice & Order</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
